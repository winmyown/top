...
/**
 * 一个虚拟缓冲区，它将多个缓冲区显示为单个合并的缓冲区。建议使用
 * {@link ByteBufAllocator#compositeBuffer()} 或 {@link Unpooled#wrappedBuffer(ByteBuf...)} 而不是显式调用构造函数。
 */
public class CompositeByteBuf extends AbstractReferenceCountedByteBuf implements Iterable<ByteBuf> {
     ...
     * 添加给定的 {@link ByteBuf}。
     * <p>
     * 请注意，此方法不会增加 {@link CompositeByteBuf} 的 {@code writerIndex}。
     * 如果需要增加，请使用 {@link #addComponent(boolean, ByteBuf)}。
     * <p>
     * {@link ByteBuf#release()} 对 {@code buffer} 的所有权将转移给此 {@link CompositeByteBuf}。
     * @param buffer 要添加的 {@link ByteBuf}。{@link ByteBuf#release()} 的所有权将转移给此
     * {@link CompositeByteBuf}。
     */
     ...
     * <p>
     * 请注意，此方法不会增加 {@link CompositeByteBuf} 的 {@code writerIndex}。
     * 如果需要增加，请使用 {@link #addComponents(boolean, ByteBuf[])}。
     * <p>
     * {@link ByteBuf#release()} 对 {@code buffers} 中所有 {@link ByteBuf} 对象的所有权将转移给此 {@link CompositeByteBuf}。
     * @param buffers 要添加的 {@link ByteBuf}。{@link ByteBuf#release()} 对 {@code buffers} 中所有 {@link ByteBuf} 对象的所有权将转移给此 {@link CompositeByteBuf}。
     */
     ...
     * <p>
     * 请注意，此方法不会增加 {@link CompositeByteBuf} 的 {@code writerIndex}。
     * 如果需要增加，请使用 {@link #addComponents(boolean, Iterable)}。
     * <p>
     * {@link ByteBuf#release()} 的所有权从 {@code buffers} 中的所有 {@link ByteBuf} 对象转移到此
     * {@link CompositeByteBuf}。
     * @param buffers 要添加的 {@link ByteBuf}。{@link ByteBuf#release()} 的所有权从所有 {@link ByteBuf} 对象转移到此 {@link CompositeByteBuf}。
     */
    ...
    /**
     * 在指定索引处添加给定的 {@link ByteBuf}。
     * <p>
     * 请注意，此方法不会增加 {@link CompositeByteBuf} 的 {@code writerIndex}。
     * 如果需要增加它，请使用 {@link #addComponent(boolean, int, ByteBuf)}。
     * <p>
     * {@link ByteBuf#release()} 对 {@code buffer} 的所有权将转移给此 {@link CompositeByteBuf}。
     * @param cIndex 要添加 {@link ByteBuf} 的索引。
     * @param buffer 要添加的 {@link ByteBuf}。{@link ByteBuf#release()} 的所有权将转移给此 {@link CompositeByteBuf}。
     */
    ...
    /**
     * 添加给定的 {@link ByteBuf}，如果 {@code increaseWriterIndex} 为 {@code true}，则增加 {@code writerIndex}。
     *
     * {@link ByteBuf#release()} 对 {@code buffer} 的所有权将转移给此 {@link CompositeByteBuf}。
     * @param buffer 要添加的 {@link ByteBuf}。{@link ByteBuf#release()} 的所有权将转移给此 {@link CompositeByteBuf}。
     */
    ...
    /**
     * 添加给定的 {@link ByteBuf}s，如果 {@code increaseWriterIndex} 为 {@code true}，则增加 {@code writerIndex}。
     *
     * {@link ByteBuf#release()} 所有权，所有 {@link ByteBuf} 对象在 {@code buffers} 中的所有权将转移给此 {@link CompositeByteBuf}。
     * @param buffers 要添加的 {@link ByteBuf}s。{@link ByteBuf#release()} 所有权，所有 {@link ByteBuf} 对象的所有权将转移给此 {@link CompositeByteBuf}。
     */
    ...
    /**
     * 在指定的索引上添加给定的 {@link ByteBuf}，如果 {@code increaseWriterIndex} 为 {@code true}，则增加 {@code writerIndex}。
     *
     * {@link ByteBuf#release()} 对 {@code buffer} 的所有权将转移给此 {@link CompositeByteBuf}。
     * @param cIndex 要添加 {@link ByteBuf} 的索引。
     * @param buffer 要添加的 {@link ByteBuf}。{@link ByteBuf#release()} 的所有权将转移给此 {@link CompositeByteBuf}。
    ...
    private int addComponent0(boolean increaseWriterIndex, int cIndex, ByteBuf buffer) {
        ...
        try {
            ...
            // 参见 https://github.com/netty/netty/issues/10194
    ...
    private Component newComponent(final ByteBuf buf, final int offset) {
        ...
        // 剥离任何中间外层（UnreleasableByteBuf、LeakAwareByteBufs、SwappedByteBuf）
    ...
    /**
     * 在指定索引处添加给定的 {@link ByteBuf}s
     * <p>
     * 请注意，此方法不会增加 {@link CompositeByteBuf} 的 {@code writerIndex}。
     * 如果需要增加，您需要自行处理。
     * <p>
     * {@link ByteBuf#release()} 所有 {@link ByteBuf} 对象的所有权将转移到此 {@link CompositeByteBuf}。
     * @param cIndex 要添加 {@link ByteBuf} 的索引。{@link ByteBuf#release()} 所有 {@link ByteBuf} 对象的所有权将转移到此
     * {@link CompositeByteBuf}。
     * @param buffers 要添加的 {@link ByteBuf}s。{@link ByteBuf#release()} 所有 {@link ByteBuf} 对象的所有权将转移到此 {@link CompositeByteBuf}。
     */
    ...
    private CompositeByteBuf addComponents0(boolean increaseWriterIndex,
        ...
        // 只有在移位后才设置 ci，以便 finally 块的逻辑始终正确
     ...
     * 如果需要增加，您需要自行处理。
     * <p>
     * {@link ByteBuf#release()} 对 {@code buffers} 中所有 {@link ByteBuf} 对象的所有权将转移给此
     * {@link CompositeByteBuf}。
     * @param cIndex 要添加 {@link ByteBuf} 的索引。
     * @param buffers 要添加的 {@link ByteBuf}s。{@link ByteBuf#release()} 对 {@code buffers} 中所有
     * {@link ByteBuf} 对象的所有权将转移给此 {@link CompositeByteBuf}。
     */
    ...
    /**
     * 添加给定的 {@link ByteBuf}，如果 {@code increaseWriterIndex} 为 {@code true}，则增加 {@code writerIndex}。如果提供的缓冲区本身是 {@link CompositeByteBuf}，则会执行其可读组件的“浅拷贝”。因此，实际添加的新组件数量可能会有所不同，特别是如果提供的缓冲区不可读，则数量为零。
     * <p>
     * {@link ByteBuf#release()} 对 {@code buffer} 的所有权将转移给此 {@link CompositeByteBuf}。
     * @param buffer 要添加的 {@link ByteBuf}。{@link ByteBuf#release()} 的所有权将转移给此 {@link CompositeByteBuf}。
     */
    ...
    private CompositeByteBuf addComponents(boolean increaseIndex, int cIndex, Iterable<ByteBuf> buffers) {
        if (buffers instanceof ByteBuf) {
            ...
            // 如果缓冲区也实现了 ByteBuf（例如 CompositeByteBuf），则必须调用 addComponent(ByteBuf)。
    ...
    /**
     * 这应该仅作为方法的最后操作调用，因为这可能会调整底层组件数组，从而影响索引等。
     */
    private void consolidateIfNeeded() {
        // Consolidate if the number of components will exceed the allowed maximum by the current
        // 如果组件数量将超过当前允许的最大值，则进行合并
        // operation.
        // 操作
        int size = componentCount;
    ...
    /**
     * 从给定索引处移除 {@link ByteBuf}。
     *
     * @param cIndex 要移除 {@link ByteBuf} 的索引
     */
    public CompositeByteBuf removeComponent(int cIndex) {
        ...
        if (comp.length() > 0) {
            ...
            // 仅当长度大于0时才需要调用updateComponentOffsets
            updateComponentOffsets(cIndex);
        }
        return this;
    }
    ...
    /**
     * 从给定索引开始移除指定数量的 {@link ByteBuf}。
     *
     * @param cIndex 开始移除 {@link ByteBuf} 的索引
     * @param numComponents 要移除的组件数量
     */
    ...
    protected int forEachByteAsc0(int start, int end, ByteProcessor processor) throws Exception {
        ...
        for (int i = toComponentIndex0(start), length = end - start; length > 0; i++) {
            ...
            // 避免在 AbstractByteBuf 情况下进行额外的检查
    ...
    /**
     * 与 {@link #slice(int, int)} 相同，只是此方法返回一个列表。
     */
    ...
    /**
     * 返回指定索引上的 {@link ByteBuf}
     *
     * @param cIndex 需要返回 {@link ByteBuf} 的索引
     * @return buf 指定索引上的 {@link ByteBuf}
     */
    ...
    /**
     * 返回指定索引处的 {@link ByteBuf}
     *
     * @param offset 需要返回 {@link ByteBuf} 的偏移量
     * @return 指定索引处的 {@link ByteBuf}
     */
    ...
    /**
     * 返回指定索引处的内部 {@link ByteBuf}。请注意，更新返回缓冲区的索引将导致此缓冲区的行为未定义。
     *
     * @param cIndex 应返回 {@link ByteBuf} 的索引
     */
    ...
    /**
     * 返回指定偏移量处的内部 {@link ByteBuf}。请注意，更新返回缓冲区的索引将导致此缓冲区的行为未定义。
     *
     * @param offset 应返回 {@link ByteBuf} 的偏移量
     */
     ...
     * 合并组合的 {@link ByteBuf}s
     *
     * @param cIndex 开始组合的索引
     * @param numComponents 要组合的组件数量
     */
    ...
    public CompositeByteBuf discardReadComponents() {
        ...
        // 如果 (readerIndex = writerIndex = capacity)，则丢弃所有内容。
    ...
    private static final class Component {
        ...
        void free() {
            ...
            // 对未包装的 buf 的引用计数（例如，如果是 PooledSlicedByteBuf）
            srcBuf.release();
        }
    }
    ...
    protected void deallocate() {
        ...
        // 我们不使用 foreach 以避免创建迭代器。
        // see https://github.com/netty/netty/issues/2642
        // 参见 https://github.com/netty/netty/issues/2642
        for (int i = 0, size = componentCount; i < size; i++) {
            components[i].free();
        }
    }
