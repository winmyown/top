...
import static org.top.java.netty.example.http2.Http2ExampleUtil.firstValue;
import static org.top.java.netty.example.http2.Http2ExampleUtil.toInt;
 ...
 * 该请求在到达此处之前已由{@link InboundHttp2ToHttpAdapter}进行转换。
 * 更多详细信息，请查看{@link Http2OrHttpHandler}，其中设置了管道。
 */
