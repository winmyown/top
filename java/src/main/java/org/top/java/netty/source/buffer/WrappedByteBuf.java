 ...
 * 包装另一个{@link ByteBuf}。
 *
 * 重要的是，{@link #readerIndex()}和{@link #writerIndex()}不会因为{@link ByteBufUtil#writeAscii(ByteBuf, CharSequence)}
 * 和{@link ByteBufUtil#writeUtf8(ByteBuf, CharSequence)}的内部优化而对索引进行任何动态调整。
 */
