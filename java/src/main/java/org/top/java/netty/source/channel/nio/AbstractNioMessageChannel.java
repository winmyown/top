...
/**
 * {@link AbstractNioChannel} 基类，用于操作消息的 {@link Channel}。
 */
public abstract class AbstractNioMessageChannel extends AbstractNioChannel {
    ...
    /**
     * 如果发生写入错误时我们应继续写入循环，则返回 {@code true}。
     */
    ...
    protected boolean closeOnReadError(Throwable cause) {
        ...
        if (cause instanceof IOException) {
            ...
            // ServerChannel 即使在发生 IOException 时也不应关闭，因为它通常可以继续运行
    ...
    /**
     * 向底层的 {@link java.nio.channels.Channel} 写入消息。
     *
     * @return 当且仅当消息已写入时返回 {@code true}
     */
