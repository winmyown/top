...
public class Collections {
     ...
     *
     * @implNote
     * This implementation defers to the {@link List#sort(java.util.Comparator)}
     ...
     * {@link #sort(List, java.util.Comparator) sort(List, Comparator)}
     ...
     */
    @SuppressWarnings("unchecked")
    public static <T> int binarySearch(List<? extends T> list, T key, java.util.Comparator<? super T> c) {
        if (c==null)
    ...
    private static <T> int indexedBinarySearch(List<? extends T> l, T key, java.util.Comparator<? super T> c) {
        int low = 0;
        int high = l.size()-1;
    ...
    private static <T> int iteratorBinarySearch(List<? extends T> l, T key, java.util.Comparator<? super T> c) {
        int low = 0;
        int high = l.size()-1;
     ...
     */
    @SuppressWarnings({"unchecked", "rawtypes"})
    public static <T> T min(Collection<? extends T> coll, java.util.Comparator<? super T> comp) {
        if (comp==null)
     ...
     */
    @SuppressWarnings({"unchecked", "rawtypes"})
    public static <T> T max(Collection<? extends T> coll, java.util.Comparator<? super T> comp) {
        if (comp==null)
    ...
    static class UnmodifiableNavigableSet<E>
        ...
        private static class EmptyNavigableSet<E> extends UnmodifiableNavigableSet<E>
            ...
            public EmptyNavigableSet() {
                super(new org.top.java.source.collection.TreeSet<E>());
            }
    ...
    static class CheckedCollection<E> implements Collection<E>, Serializable {
        ...
        Collection<E> checkedCopyOf(Collection<? extends E> coll) {
            ...
            return (Collection<E>) java.util.Arrays.asList(a);
        }
...
/**
        ...
        implements NavigableMap<K,V>, Serializable
    {
        ...
        public java.util.Comparator<? super K> comparator()   { return nm.comparator(); }
